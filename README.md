...
- External TimescaleDB/PostgreSQL and Valkey-compatible cache secrets.
...
`vultr-values.yaml` models OpenCord Cloud on Vultr with self-hosted external TimescaleDB, external Valkey-compatible cache, Vultr Object Storage, LiveKit, TURN, ingress, TLS, and HPA enabled.
